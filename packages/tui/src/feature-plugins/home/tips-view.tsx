...
const TIPS: Tip[] = [
  ...
  "Create {highlight}bcode.json{/highlight} for server settings, and {highlight}tui.json{/highlight} for TUI",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.bcode/commands/{/highlight} for reusable prompts",
